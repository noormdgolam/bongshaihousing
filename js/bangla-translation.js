...
const dictionary = {
    'en': {
        ...
        'ftue_title': 'Welcome to Bongshai Housing',
        'ftue_desc': 'Experience Bangladesh\'s premier prefab and steel building solutions. We build dreams with international quality and unwavering commitment to excellence.',
        'ftue_explore': 'Explore Packages',
        'hero_mission': '<span class="dot"></span> Low cost, High quality is our mission',
    ...
    'bn': {
        ...
        'ftue_title': 'বংগশাই হাউজিং-এ স্বাগতম',
        'ftue_desc': 'বাংলাদেশের শীর্ষস্থানীয় প্রিফ্যাব এবং স্টিল বিল্ডিং সমাধানের অভিজ্ঞতা নিন। আন্তর্জাতিক মানের এবং শ্রেষ্ঠত্বের প্রতি অটল প্রতিশ্রুতি দিয়ে আমরা স্বপ্ন নির্মাণ করি।',
        'ftue_explore': 'প্যাকেজসমূহ দেখুন',
        'hero_mission': '<span class="dot"></span> স্বল্প ব্যয় ও উচ্চ মান নিশ্চিত করাই আমাদের লক্ষ্য',
        'hero_title': 'বাংলাদেশে প্রিমিয়ার <span class="highlight">প্রিফ্যাব নির্মাণ</span><br/>প্রযুক্তি',
