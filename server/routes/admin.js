...
router.get('/admin/roles', requireRole('admin', 'superadmin'), async (req, res) => {
  const matrix = [
    { module: 'Executive Dashboard & Overview', path: '/admin', roles: ['superadmin', 'admin', 'editor', 'sales'], description: 'High-level KPI cards and stats' },
    { module: 'Customer Inquiries & CRM Leads', path: '/admin/leads*', roles: ['superadmin', 'admin', 'editor', 'sales'], description: 'Quote requests, phone calls, contact submissions' },
    { module: 'Orders & Milestone Tracking', path: '/admin/orders*', roles: ['superadmin', 'admin', 'editor', 'sales'], description: 'Client project orders, milestones, payments' },
    { module: 'Agent Directory & Approvals', path: '/admin/agents*', roles: ['superadmin', 'admin', 'editor', 'sales'], description: 'Channel partners, applications, territory review' },
    { module: 'Agent Submitted Leads', path: '/admin/agent-leads*', roles: ['superadmin', 'admin', 'editor', 'sales'], description: 'Leads generated by field agents' },
    { module: 'Agent Invitation Campaigns', path: '/admin/agents/invite*', roles: ['superadmin', 'admin', 'editor'], description: 'Excel/CSV bulk invitations, email templates' },
    { module: 'Product Catalog & Models', path: '/admin/products*', roles: ['superadmin', 'admin', 'editor'], description: 'Steel building models, specs, pricing, gallery' },
    { module: 'Categories & Types', path: '/admin/categories*', roles: ['superadmin', 'admin', 'editor'], description: 'Simplex, Duplex, Triplex, Factory sheds' },
    { module: 'Completed & Ongoing Projects', path: '/admin/projects*', roles: ['superadmin', 'admin', 'editor'], description: 'Case studies, project portfolio, featured flags' },
    { module: 'Marketing Pages Content', path: '/admin/pages*', roles: ['superadmin', 'admin', 'editor'], description: 'Landing page copy, about, contact, calculator' },
    { module: 'Nationwide Service Areas', path: '/admin/service-areas*', roles: ['superadmin', 'admin', 'editor'], description: '64 Bangladesh districts, landing page generators' },
    { module: 'FAQs Management', path: '/admin/faqs*', roles: ['superadmin', 'admin', 'editor'], description: 'Question/Answer knowledgebase' },
    { module: 'Team Members Directory', path: '/admin/team-members*', roles: ['superadmin', 'admin', 'editor'], description: 'Company leadership and staff profiles' },
    { module: 'Testimonials & Reviews', path: '/admin/testimonials*', roles: ['superadmin', 'admin', 'editor'], description: 'Client quotes and feedback' },
    { module: 'Media Library', path: '/admin/media*', roles: ['superadmin', 'admin', 'editor'], description: 'Asset uploads and image processor' },
    { module: 'Theme Studio Pro & Presets', path: '/admin/theme-editor*', roles: ['superadmin', 'admin', 'editor'], description: 'Visual styling, presets, color palettes' },
    { module: 'SEO Automation & Audits', path: '/admin/seo*', roles: ['superadmin', 'admin', 'editor'], description: 'Technical audits, suggestions, batch generation' },
    { module: 'SEO Global API Settings', path: '/admin/seo/settings*', roles: ['superadmin', 'admin'], description: 'Groq/Cloud API keys, automated cron triggers' },
    { module: 'Admin Users & Accounts', path: '/admin/users*', roles: ['superadmin', 'admin'], description: 'Manage accounts, passwords, assign roles' },
    { module: 'Activity Audit Trail', path: '/admin/activity*', roles: ['superadmin', 'admin'], description: 'System mutations and security logs' },
    { module: 'Role & Permission Audit', path: '/admin/roles', roles: ['superadmin', 'admin'], description: 'Dynamic access control verification matrix' },
  ];

  res.render('admin/roles.njk', adminVars(req, { matrix }));
});
