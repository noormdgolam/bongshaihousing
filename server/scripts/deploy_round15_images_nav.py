...
FILES = [
    ("kaliganj-dhaka.html", "bongshaihousing.com/kaliganj-dhaka.html"),
    ("images/products/coming-soon-placeholder.png", "bongshaihousing.com/images/products/coming-soon-placeholder.png"),
    ("images/products/coming-soon-placeholder.svg", "bongshaihousing.com/images/products/coming-soon-placeholder.svg"),
    ("images/uploads/project-photo-unavailable.png", "bongshaihousing.com/images/uploads/project-photo-unavailable.png"),
    ("images/uploads/project-photo-unavailable.svg", "bongshaihousing.com/images/uploads/project-photo-unavailable.svg"),
    ("server/views/partials/nav.njk", "bongshai-node-app-prod/views/partials/nav.njk"),
    ("server/views/partials/nav.njk", "bongshai-node-app/views/partials/nav.njk"),
]
