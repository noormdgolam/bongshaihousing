...
FILES = [
    ("server/page-registry.json", "bongshai-node-app-prod/page-registry.json"),
    ("server/page-registry.json", "bongshai-node-app/page-registry.json"),
    ("server/views/pages/kaliganj-dhaka.njk", "bongshai-node-app-prod/views/pages/kaliganj-dhaka.njk"),
    ("server/views/pages/kaliganj-dhaka.njk", "bongshai-node-app/views/pages/kaliganj-dhaka.njk"),
]
