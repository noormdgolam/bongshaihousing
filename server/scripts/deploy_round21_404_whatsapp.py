...
FILES = [
    ("404.html", "bongshaihousing.com/404.html"),
    ("server/views/pages/404.njk", "bongshai-node-app-prod/views/pages/404.njk"),
    ("server/views/pages/404.njk", "bongshai-node-app/views/pages/404.njk"),
]
