...
FILES = [
    ("contact.html", "bongshaihousing.com/contact.html"),
    ("solutions.html", "bongshaihousing.com/solutions.html"),
    ("js/division-districts.js", "bongshaihousing.com/js/division-districts.js"),
    ("server/views/pages/contact.njk", "bongshai-node-app-prod/views/pages/contact.njk"),
    ("server/views/pages/contact.njk", "bongshai-node-app/views/pages/contact.njk"),
    ("server/views/pages/solutions.njk", "bongshai-node-app-prod/views/pages/solutions.njk"),
    ("server/views/pages/solutions.njk", "bongshai-node-app/views/pages/solutions.njk"),
]
