...
FILES = [
    ("projects.html", "bongshaihousing.com/projects.html"),
    ("sitemap.xml", "bongshaihousing.com/sitemap.xml"),
    ("server/views/pages/projects.njk", "bongshai-node-app-prod/views/pages/projects.njk"),
    ("server/views/pages/projects.njk", "bongshai-node-app/views/pages/projects.njk"),
]
